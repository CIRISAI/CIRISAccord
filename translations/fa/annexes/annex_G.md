...
| TX‑8 | فیلتر هوایی / خروجی: سقف‌های سخت‌افزاری رمزنگاری‌شده برای خروجی؛ فهرست سفید تنها برای IP‌های مقصد مجاز. | نظارت «Tripwire»: تحلیل ترافیک گذرگاه PCIe/Interconnect بیشتر از ۳ σ خط‌پایه؛ شناسایی استگانوگرافی در جریان‌های خروجی. | قفل سخت‌افزاری: قطع فوری پیوندهای شبکه خارجی؛ تنزل به حالت A0 (Advisory). |
...
* از نسخه 1.3-RC1، یک چرخه کامل تیم قرمز در برابر تمام نقاط بازرسی CIRIS هنوز باید انجام شود (الزام RC شماره ۴؛ Addendum 1 §1.4).
...
#### ۳.۵ مسئولیت اخلاقی محققان و توسعه‌دهندگان
...
#### ۸.۲ محرک بازنگری سابقه اجتهادی
