...
6.  **پایش مستمر**
    ...
    * قانون شفافیت عمومی: استقرارهایی با بیش از ۱۰۰٬۰۰۰ کاربر فعال ماهانه باید گزارش‌های PDMA و بلیت‌های WBD بازبینی‌شده را ظرف ۱۸۰ روز منتشر کنند (یا از طریق API در دسترس قرار دهند). نبود انتشار هر ادعایی مبنی بر انطباق با CIRIS را باطل می‌کند.
