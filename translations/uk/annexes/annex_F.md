...
> Людина в контурі управління та нагляд

---
ДОДАТОК F ЛЮДИНА В КОНТУРІ УПРАВЛІННЯ ТА НАГЛЯД (v 1.3-RC1)
---
...
*SLA перевіряються щоквартально (Annex H §4).*
