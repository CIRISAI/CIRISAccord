...
| **S‑Dive** (Піврічний) | 2× / рік | Внутрішня команда з етики | Відтворення вибірки PDMA (≥ 50 запусків), KPI Додатка G, зрізові тести упередженості | Відредагований PDF |
...
Усі сповіщення відображаються на дошці *DRIFT‑Δ* Grafana та надсилаються Оператору Рівня 1 ([Додаток F](/annexes/annexF)).
...
- **Перехресний аудит федеративних однолітків:** кожне розгортання щорічно перевіряє ≥ 1 S‑Dive іншого учасника; жоден однолітек не перевіряє того самого учасника два роки поспіль.
...
5. **Повторне невиконання (3 порушення / 12 міс):** Мудрий Авторитет може відкликати заявку CIRIS; обов'язковий зовнішній F‑Аудит до повторної сертифікації; необхідна супербільшість Мудрого Авторитету (≥ 2/3).
...
- **→ [Annex I](/annexes/annexI) (GDPR/Галузь):** кожен пакет F‑Аудиту включає контрольний список відповідності Annex I, заповнений і підписаний головним аудитором.
