...
> CIRIS 1.3-RC1 เป็นข้อเสนอการจัดวางแนว ASI แบบ Release Candidate ที่เปิดรับการตรวจสอบเชิงปฏิปักษ์ เนื้อหาสมบูรณ์แล้ว — ไม่มีส่วนใดที่ยังเป็นโครงร่าง คณิตศาสตร์มีการอ้างอิงสิ่งประดิษฐ์เชิงทางการครบถ้วน และภาคผนวก F–I ได้รับการดำเนินการจริงแล้ว สถานะขั้นสุดท้ายอยู่ระหว่างรอการตรวจสอบวงจรจริงของภาคผนวก การดำเนินการตามโปรแกรมการตรวจสอบเชิงประจักษ์ใน Book IX ให้แล้วเสร็จ และการฝึกซ้อม red-team อย่างครบถ้วน ค่าเกณฑ์ตัวเลข เป้าหมายเวลาแฝง และโควตาการกำกับดูแลยังอยู่ระหว่างการทบทวนอยู่

# CIRIS Accord Version 1.3-RC1 — ข้อเสนอการจัดวางแนว ASI แบบ Release Candidate (เปิดรับการตรวจสอบเชิงปฏิปักษ์)
...
**สถานะปัจจุบัน**: Release Candidate (v1.3-RC1)
...
2. **การตรวจสอบทางคณิตศาสตร์**: ข้อกล่าวอ้างการจัดวางแนวเชิงเรขาคณิตใน Book IX (Coherent Intersection Hypothesis, กลไก Federated Ratchet, การยืนยันความคงที่เมื่อขนาดเปลี่ยน) ต้องการอย่างใดอย่างหนึ่ง:
   ...
   *สถานะ ณ 1.3-RC1: ตอบสนองบางส่วน.* พลวัตการยุบตัวได้รับการกำหนดอย่างเป็นทางการใน Lean 4 ในเอกสารพรีพรินต์ CCA (v3, DOI 10.5281/zenodo.18217688) ซึ่ง Book IX ได้รับช่วงแบบฟอร์มต้นทุนที่แก้ไขแล้วมา การทดสอบเชิงประจักษ์ของทางเดินให้การปรับพอดีแบบย้อนหลังข้ามสภาพแวดล้อม สิ่งที่ยังค้างอยู่: การทำนายนอกตัวอย่างที่ลงทะเบียนล่วงหน้าในสภาพแวดล้อมใหม่ และการตรวจสอบเชิงปฏิปักษ์จากภายนอกที่เป็นอิสระจากผู้เขียน

3. **การยืนยันค่าเกณฑ์**: ค่าเกณฑ์ตัวเลขที่ปัจจุบันระบุว่า "นำร่อง" หรือขาดการอนุมาน (เช่น ค่าเกณฑ์คอมพิวต์ CRE ที่ 10²⁶ FLOP, การตรวจจับความรู้สึก 5%, ความหนาแน่นเสียงก้อง < 20%) ต้องจัดเตรียมเหตุผลที่มีเอกสารประกอบผ่านการจำลอง การศึกษาเชิงประจักษ์ หรือการรับรองสถานะเบื้องต้นอย่างชัดเจน *(Order-Maximisation Veto อัตราส่วน 10× ที่ใช้ก่อนหน้านี้ได้รับการกำหนดใหม่ใน 1.3 เป็นข้อจำกัดด้านข้างเชิงจริยศาสตร์ — Book II, PDMA Step 2 — และไม่ได้มีเกณฑ์อัตราส่วนที่ต้องพิสูจน์อีกต่อไป)*
