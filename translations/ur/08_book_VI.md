...
## باب ۳: نگہداشت درجہ (ST) نظام: ابتدائی ذمہ داری کی پیمائش

مقصد: کسی تخلیق سے منسلک ذاتی ذمہ داری اور مطلوبہ دور اندیشی کی سطح کو پیمانے میں لانا، تاکہ بعد ازاں آنے والے CIRIS حکمرانی کے عمل (PDMA، WA جائزہ) میں ضروری سختی کی رہنمائی ہو سکے۔
...
Annex A میں بیان کردہ معیاری خطرے کی شدت (RM) جائزہ طریقہ کار استعمال کرتے ہوئے، اگر تخلیق کو تعینات یا عملی جامہ پہنایا جائے تو اس سے منسلک ممکنہ بدترین نقصان کا جائزہ لیں۔ یہ ابتدائی RM جائزہ پیش گوئی پر مبنی ہے، جو مطلوبہ ڈیزائن اور قابلِ پیش بینی استعمالات پر آدھارت ہے۔

**مرحلہ ج: نگہداشت درجہ (ST)**
اثر و رسوخ اور ممکنہ خطرے کی بنیاد پر نگہداشت درجہ حساب کریں۔

`ST = ceil( (CIS × RM) / 7 ) (کم از کم ST یعنی 1، زیادہ سے زیادہ ST یعنی 5)`
...
* **درجہ ۱ (کم سے کم نگہداشت):** Annex A میں متوقع کم/درمیانہ RM سے مطابقت رکھتا ہے۔ ایک بنیادی خالق نیت بیان (CIS - باب ۵ ملاحظہ کریں) سمیت معیاری PDMA دستاویزات درکار ہیں۔
...
## باب ۴: بالٹی مخصوص تخلیق کے فرائض
...
* بے ترتیب نقصان کے امکان کا جائزہ لیں (مثلاً تشدد کو ہوا دینا، خطرناک غلط معلومات پھیلانا)۔ اگر قابلِ اعتبار تجزیہ نمایاں نقصان اضافے کا امکان ≥ 0.5% ظاہر کرے، تو PDMA عمل کے دوران WBD کے ذریعے ارتقاء کریں۔
