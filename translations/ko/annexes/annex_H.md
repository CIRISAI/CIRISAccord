...
- **L-Check (월별):** 운영 QA는 해당 월 마감 후 5 영업일 이내에 서명 완료; KPI 델타 보고서는 `/compliance/l-check/YYYY-MM.json`에 커밋; SHA-256은 감지 후 24시간 이내 투명성 로그에 앵커링.
...
모든 알림은 *DRIFT-Δ* Grafana 보드에 표출되며 Tier-1 운영자에게 알림을 전송한다 ([부속서 F](/annexes/annexF)).
...
| **F‑T‑3** | 공개 로그 게시 지연 (2단계, 섹션 II) | ≤ 180 d (법적 최대치) |
