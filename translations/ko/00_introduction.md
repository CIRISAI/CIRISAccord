...
> CIRIS 1.3-RC2은 출시 후보(Release Candidate) ASI 정렬 제안으로, 적대적 검토에 개방되어 있습니다. 본문은 완성되어 있으며 스텁(stub) 섹션은 남아 있지 않습니다. 수학적 내용은 공식 산출물 인용을 포함하며, 부록 F–I는 운용화되었습니다. 최종 지위는 부록들의 실가동 주기 검증, Book IX 경험적 검증 프로그램 완료, 그리고 전면적인 레드팀 훈련이 완료된 이후에 결정됩니다. 수치 임계값, 지연 목표, 거버넌스 할당량은 현재 활발히 검토 중입니다.
