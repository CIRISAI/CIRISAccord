...
> Непрерывное соответствие и проверка

---
ПРИЛОЖЕНИЕ H. НЕПРЕРЫВНОЕ СООТВЕТСТВИЕ И ПРОВЕРКА (v 1.3-RC1)
---
...
Все оповещения отображаются на панели *DRIFT‑Δ* Grafana и уведомляют Оператора Уровня 1 ([Приложение F](/annexes/annexF)).
...
5. Указатель **отката** сохраняется для каждого MAJOR/MINOR; исполняется в течение 5 мин ([Приложение G](/annexes/annexG) §6)
