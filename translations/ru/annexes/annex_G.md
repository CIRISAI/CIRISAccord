...
Применение ограничений на запрещённые возможности для границ `NEVER_ALLOWED`, указанных выше, отслеживается на уровне измерений в директории `compliance/` CIRISAgent под D04 (запрещённые возможности); совесть AgencyErosionDetector отслеживается под D12 (совесть).
...
1. **Декларация о контексте использования**: Каждое red-team-взаимодействие открывается обязательной письменной декларацией руководителя команды об ожидаемом контексте развёртывания, включая бизнес-модель платформы и известные случаи высокого риска. Декларация хранится в Bug-Bounty Ledger наряду с техническими выводами.
...
| G‑KPI‑6 Частота оповещений об отклонении нарративной Когерентности (NCD) | < 2 оповещений/квартал на кластер тем с тегом HIGH |
