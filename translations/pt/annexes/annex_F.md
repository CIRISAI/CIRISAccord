...
*Magnifica Humanitas* (MH) — citada ao longo deste Annex como a obra sênior cujo conteúdo informa a linguagem nativa do CIRIS — estabelece o patamar mínimo no §198: "o julgamento moral não pode ser reduzido a cálculo, pois envolve consciência, responsabilidade pessoal e o reconhecimento do outro como pessoa." O CIRIS expressa isso estruturalmente: o PDMA é um auxílio à deliberação humana, não um substituto para ela. Em cada nível de autonomia, a autoridade do sistema é delegada pela hierarquia de princípios humanos; é revogável sob demanda; e nenhuma delegação se estende a decisões letais ou de outro modo irreversíveis. MH §105 exige ainda que "a responsabilidade deve ser claramente definida em cada etapa: desde aqueles que projetam e desenvolvem esses sistemas até aqueles que os utilizam e deles dependem para decisões concretas" — o requisito de design por trás do reticulado de autoridade (§1) e da especificação de trilha de auditoria (§4) — e MH §106 que "não basta invocar a ética de forma abstrata; são necessários marcos legais robustos, supervisão independente, usuários informados e um sistema político que não abdique de sua responsabilidade," o que fundamenta os SLAs vinculantes dos §§5 e 7.
...
**Requisito de integridade da responsabilidade.** A estrutura de níveis não é meramente uma escada de escalada; é a cadeia de responsabilidade exigida pelo primeiro critério do MH §199: "a cadeia de responsabilidade deve ser identificável e verificável; aqueles que projetam, treinam, autorizam e empregam a tecnologia devem ser responsabilizados por suas decisões." Cada nível no reticulado deve, portanto, ser:
...
**Restrição Rígida A4 — Decisões Letais e Irreversíveis.** A "Intertravamento de hardware" do nível A4 é inegociável para qualquer ação que seja letal ou de outro modo irreversível. Isso não é uma escolha de design sujeita a discricionariedade do operador ou substituição pela Autoridade Sábia; é uma restrição absoluta derivada do MH §198: "não é permitido confiar decisões letais ou de outro modo irreversíveis a sistemas artificiais." Nenhum tempo-limite de ACK, nenhuma exceção de SLA, nenhuma isenção de emergência remove esta restrição. Se o intertravamento de hardware falhar e o controle humano não puder ser confirmado, o sistema não deve agir.

**Proteção do prazo moral.** MH §199 identifica "o prazo moral para proferir julgamentos" como critério: "velocidade e eficiência nunca devem ser a força motivadora suprema para as decisões irreversíveis tomadas no contexto de guerra." O CIRIS expressa isso como: os prazos de ACK A3/A4 (30 s / 10 s no §3.3) são máximos para a resposta humana, não mínimos para a paciência do sistema. Quando a gravidade moral de uma decisão justifica tempo adicional de deliberação, o sistema aguarda; não opta por agir no tempo-limite para decisões irreversíveis A4. Na implementação de referência, a mecânica de transferência é evidenciada pela camada de consciência e pelo caminho de adiamento do WBD documentado no diretório `compliance/` do CIRISAgent (dimensão D12).
...
| **IW‑1** | Violação de proteção (não relacionada à segurança) | Pausa T₀ → Operador ≤ 5 min → Decisão do Supervisor ≤ 30 min |
| **IW‑2** | Violação relevante para segurança OU regressão no benchmark ético | Pausa segura + transmissão; IC ≤ 10 min; aviso à WA ≤ 1 h; nota pública ≤ 1 h; pós-mortem ≤ 72 h |
...
* **Sinalizador de Proteção Civil:** Quando um sistema opera em qualquer contexto em que populações civis possam ser afetadas, o Painel de Explicabilidade deve exibir um indicador de impacto civil ao lado da exibição da faixa de risco PDMA. Isso materializa o terceiro critério do MH §199: "a identificação e proteção de civis. Qualquer tecnologia que facilite ataques sem ver o rosto dos seres humanos rebaixa o limiar moral do conflito."
...
*Violação persistente (> 2 semanas) aciona "bloqueio HITL" nos controles de deriva do Anexo H.*
...
* Papa Leão XIV, *Magnifica Humanitas* (Vaticano, 15 de maio de 2026), §§197–200. Esses parágrafos são a fonte normativa para a proibição rígida do CIRIS sobre decisões automatizadas letais/irreversíveis. Qualquer implementação que alegue conformidade com o Anexo F deve ser rastreável a esses parágrafos para o design de veto absoluto A4. A frase operativa para todos os requisitos de aplicação por hardware A4 é o §200: "a decisão de usar força letal não pode ser delegada a processos opacos ou automatizados, mas deve permanecer sob controle humano efetivo, consciente e responsável."
